...
public class FuelDispenserController {
    ...
    @PostMapping
    public ResponseEntity<List<FuelDispenser>> postFuels(@RequestBody List<FuelDispenserDTO> dtoList){
        // Saves the fuel object with the provided data (@RequestBody) + generated ID (generated by the database)
        List<FuelDispenser> savedFuelDispensers = fuelDispenserService.insertAll(dtoList);
